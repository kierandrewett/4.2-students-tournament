...
type RSIProps = { event: EventData; value: TeamData | IndividualData; i: number };

const RankingsSortItem = SortableElement<RSIProps>(({ event, value, i }: RSIProps) => (
	<div
		className={"row"}
		key={value.id}
		style={{ position: "relative", "--col-template": "3rem 1fr 1fr" } as any}
	>
...
export const AdminFinaliseRecordEvent = ({
	...
	const [markDisabled, setMarkDisabled] = React.useState(true);
